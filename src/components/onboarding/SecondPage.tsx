...
const SecondPage = () => {
  ...
  return (
		...
		>
			...
			>
				<div className='w-[300px] h-[300px]   flex items-center justify-start  p-4 bg-white  rounded-lg relative '>
					<Image
					...
					<motion.div
						className='absolute bottom-56 -right-50 bg-white rounded-md p-2 shadow-md min-w-[300px] mt-2'
						initial={{ opacity: 0, y: 100, x: 100 }}
						whileInView={{ opacity: 1, x: 0, y: 0 }}
						exit={{ opacity: 0, y: 100, x: 100 }}
						transition={{
					...
					<motion.div
						className='absolute bottom-32 -right-60 bg-white rounded-md p-2 shadow-md min-w-[300px] '
						initial={{ opacity: 0, y: 100 }}
						whileInView={{ opacity: 1, y: 0 }}
						exit={{ opacity: 0, y: 100 }}
						transition={{
			...
			<div className='pt-14 flex flex-col items-center max-w-[500px] space-y-4'>
				...
				<p className='text-lg text-center'>
					Pick your service, choose a time, and you’re all set. Skip
					the queues and save your day.
				</p>
			</div>
		</motion.div>
  );
